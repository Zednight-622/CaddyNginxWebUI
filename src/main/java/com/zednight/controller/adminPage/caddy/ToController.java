...
import com.zednight.ext.UpstreamExt;
import com.zednight.model.Upstream;
import com.zednight.model.UpstreamServer;
import com.zednight.service.ParamService;
...
@Controller
@RequestMapping("/adminPage/to")
public class ToController extends BaseController {
    @Autowired
...
//		}
        ...
        modelAndView.setViewName("/adminPage/caddyTo/index");
        return modelAndView;
    }
